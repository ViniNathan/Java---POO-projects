...
public class Seguradora {
    ...
    public Seguro gerarSeguro(Date dataInicio, Date dataFim, Cliente cliente, Frota frota, int valorMensal, String tipoSeguro) {
        if (tipoSeguro.equalsIgnoreCase("PF")) {
            ...
            for (Veiculo veiculo : frota.getListaVeiculos()) {
                Seguro seguro = new SeguroPF(dataInicio, dataFim, this, valorMensal, veiculo, clientePF);
                listaSeguros.add(seguro); // Adiciona o seguro à lista de seguros da seguradora
                return seguro;
            }
        } else if (tipoSeguro.equalsIgnoreCase("PJ")) {
            ClientePJ clientePJ = (ClientePJ) cliente;
            Seguro seguro = new SeguroPJ(dataInicio, dataFim, this, valorMensal, frota, clientePJ);
            listaSeguros.add(seguro); // Adiciona o seguro à lista de seguros da seguradora
            return seguro;
        } else {
    ...
    // Método para encontrar um veiculo na lista pela placa
    ...
    // Método para encontrar uma frota na lista pelo seu codigo
	public Frota buscarFrotaPorCodigo(String codigo) {
        for (Frota frota : listaFrotas) {
            if (frota.getCode().equalsIgnoreCase(codigo)) {
                return frota; // Retorna o veículo encontrado
            }
        }
        return null; // Retorna null caso o veículo não seja encontrado
	}
